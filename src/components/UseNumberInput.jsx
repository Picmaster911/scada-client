...
export default function UseNumberInput({ callbkF }) {
...
const StyledInputRoot = styled('div')(
    ...
    column-gap: 8px;
    padding: 4px;
    min-width: 50px; // Устанавливаем минимальную ширину
...
const StyledInputElement = styled('input')(
  ({ theme }) => `
  min-width: 30px; // Устанавливаем минимальную ширину
  max-width: 70px; // Устанавливаем минимальную ширину
  font-size: 0.875rem;
  font-family: inherit;
  font-weight: 400;
  line-height: 1.5;
